...
class NestedSet_Model
{
    ...
    {
        return $this->_output('array', $nodes);
    }
    ...
    {
        return $this->_output('json', $nodes);
    }
    ...
    {
        return $this->_output('html', $nodes, $method);
    }

    protected function _output($mode, array $nodes, $method = null)
    {
        if (empty($nodes)) {
            $nodes = $this->getAll();
        }
